...
import { Text, View, StyleSheet, Button, Alert, BackHandler,AsyncStorage } from 'react-native';
...
export default class DietScreen extends Component{
    ...
    return (
      <View >
          ...
          <Button title="Doctor Location" onPress={() => {this.userLogout(),this.props.navigation.navigate('Login',{ parentNavigation: this.props.navigation })}}></Button></View>
      </View>
    );
  }}
